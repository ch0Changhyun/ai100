...
#                 writer = csv.writer(f)
#                 writer.writerow([user_id, password, name, gender])
            
#             st.success(f"환영합니다, {name}! 회원가입 성공!")
#             st.write("로그인 페이지로 이동합니다...")

#             # 세션 상태를 업데이트하여 로그인 페이지로 이동
...
#     # 세션 상태에 'current_page'가 없으면 'Home'으로 초기화
#     if 'current_page' not in st.session_state:
#         st.session_state['current_page'] = 'Home'

#     # 사이드바에서 선택한 메뉴를 세션 상태의 'current_page'로 설정
